...
export const Live = () => {
  ...
  return (
    <div className="h-[100vh] w-full flex justify-center text-center items-center" onPointerMove={handlePointerMove} onPointerLeave={handlePointerLeave} onPointerDown={handlePointerDown}>
    {cursor && (
